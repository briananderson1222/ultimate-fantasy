...
from .log_config import get_log_config, get_domain_log_levels, setup_log_directory

# Context variable for tracking request ID across async calls
request_id_var: ContextVar[Optional[str]] = ContextVar('request_id', default=None)

# Context variable for tracking current domain
current_domain_var: ContextVar[Optional[str]] = ContextVar('current_domain', default=None)
