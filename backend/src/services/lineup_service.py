...
class LineupService:
    ...
    def set_lineup(self, *, team_id: str | uuid.UUID, game_day: date, players: Iterable[dict]) -> Lineup:
        ...
        lineup = Lineup(team_id=team_uuid, game_day=game_day, players=serializable_players, version=1)
