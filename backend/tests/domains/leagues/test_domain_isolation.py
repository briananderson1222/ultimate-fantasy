...
class TestLeaguesDomainIsolation:
    ...
    def test_leagues_domain_imports(self):
        ...
        try:
            from backend.src.domains.leagues.services import league_service
            from backend.src.domains.leagues.models import league
            from backend.src.domains.leagues.api import leagues_branding
