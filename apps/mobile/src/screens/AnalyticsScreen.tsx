...
const MOCK_PLAYER_ANALYSIS: PlayerAnalysis[] = [
  {
    ...
    team: "BUF",
    weeklyPerformance: [
      24.3, 21.7, 18.9, 28.4, 22.1, 25.8, 19.6, 26.2, 23.5, 20.8,
    ],
    averagePoints: 23.13,
    consistency: 85,
  ...
  },
  {
    ...
    team: "SF",
    weeklyPerformance: [
      28.6, 15.2, 22.8, 31.4, 19.7, 26.3, 21.9, 29.1, 24.6, 18.3,
    ],
    averagePoints: 23.79,
    consistency: 72,
...
const MOCK_WEEKLY_MATCHUPS: WeeklyMatchup[] = [
  {
    ...
    opponentScore: 92.1,
    result: "L",
    pointsDifference: -4.9,
    optimalScore: 98.3,
    efficiencyPercentage: 88.7,
  },
  {
    week: 2,
    opponent: "Team Beta",
  ...
  },
  {
    ...
    opponentScore: 89.3,
    result: "L",
    pointsDifference: -12.5,
    optimalScore: 91.7,
    efficiencyPercentage: 83.8,
  },
];
...
const MOCK_INSIGHTS: TrendInsight[] = [
  {
    ...
    description:
      "Josh Allen has been consistently outperforming QB average by 6.8 points",
    impact: "high",
  ...
  },
  {
    ...
    description:
      "Running back position showing high variance with 28% consistency drop",
    impact: "medium",
  ...
  },
  {
    ...
    description:
      "Setting optimal lineups 82.5% of the time, above league average",
    impact: "medium",
  },
];
...
export default function AnalyticsScreen() {
  ...
  const [currentTab, setCurrentTab] = useState<
    "overview" | "players" | "positions" | "league" | "insights"
  >("overview");
  const [timeRange, setTimeRange] = useState<"season" | "recent" | "projected">(
    "season",
  );
    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.metricsGrid}>
          ...
          <View style={styles.metricCard}>
            <Text style={styles.metricValue}>
              {MOCK_PERFORMANCE.consistency}
            </Text>
            <Text style={styles.metricLabel}>Consistency</Text>
            <Text style={[styles.metricChange, { color: "#f59e0b" }]}>
              Above Average
            </Text>
          </View>
        </View>
        ...
        {MOCK_WEEKLY_MATCHUPS.map((matchup) => (
          <View key={matchup.week} style={styles.matchupCard}>
            <View style={styles.matchupHeader}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      matchup.result === "W" ? "#10b981" : "#ef4444",
                  },
                ]}
              >
            ...
            <Text style={styles.efficiencyText}>
              Efficiency: {matchup.efficiencyPercentage}% (Optimal:{" "}
              {matchup.optimalScore})
            </Text>
          </View>
        ))}
      </View>
          ...
          <View key={player.playerId} style={styles.playerAnalysisCard}>
            ...
            <View style={styles.playerMetrics}>
              ...
              <View style={styles.playerMetric}>
                <Text style={styles.metricValue}>
                  {player.timesStarted}/
                  {player.timesStarted + player.timesBenched}
                </Text>
        ...
        {MOCK_POSITION_ANALYSIS.map((position) => (
          <View key={position.position} style={styles.positionCard}>
            ...
            <View style={styles.positionMetrics}>
              ...
              <View style={styles.positionMetric}>
                <Text style={styles.metricValue}>
                  {position.averagePoints.toFixed(1)}
                </Text>
              ...
              <View style={styles.positionMetric}>
                <Text style={styles.metricValue}>
                  {position.dropoffToNext.toFixed(1)}
                </Text>
            ...
            <View style={styles.bestPlayer}>
              ...
              <Text style={styles.bestPlayerName}>
                {position.bestPlayer.name} (
                {position.bestPlayer.averagePoints.toFixed(1)} pts/week)
              </Text>
            </View>
          </View>
        ))}
            ...
            <View style={styles.comparisonValues}>
              ...
              <View style={styles.comparisonValue}>
                <Text style={styles.valueNumber}>
                  {comparison.leagueAverage}
                </Text>
                <Text style={styles.valueLabel}>League Avg</Text>
              </View>
              <View style={styles.comparisonValue}>
                <Text style={styles.valueNumber}>
                  {comparison.leagueMedian}
                </Text>
