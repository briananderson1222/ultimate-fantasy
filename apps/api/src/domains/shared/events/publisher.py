...
from .base import DomainEvent, IntegrationEvent, AggregateEvent
...
class EventPublishError(Exception):
    ...
    def __init__(self, message: str, event_id: Optional[str] = None, original_error: Optional[Exception] = None):
...
class PublishResult:
    ...
    def __init__(self, success: bool, event_id: str, error: Optional[str] = None, retry_after: Optional[int] = None):
