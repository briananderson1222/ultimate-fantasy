...
from typing import List, Dict, Any, Callable, Awaitable, Optional, Set, Union
from dataclasses import dataclass, field
from enum import Enum
from collections import defaultdict

from .base import DomainEvent, IntegrationEvent, EventStatus
...
class EventMatcher:
    ...
    @staticmethod
    def matches_event_type(event: DomainEvent, event_types: Union[str, List[str]]) -> bool:
    ...
    @staticmethod
    def matches_aggregate(event: DomainEvent, aggregate_ids: Union[str, List[str]]) -> bool:
