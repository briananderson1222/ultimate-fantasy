...
class Score(Base):
    ...
    opponent_team: Mapped[str | None] = mapped_column(String(10), nullable=True)
    ...
    stat_values: Mapped[dict[str, Any] | None] = mapped_column(
    ...
    scoring_type: Mapped[str] = mapped_column(
        String(20), nullable=False, default="game"
    )
    is_projected: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    is_final: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)

    last_updated_from_source: Mapped[datetime | None] = mapped_column(
