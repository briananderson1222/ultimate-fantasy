...
class TestSportsPlayersGetContract:
    ...
    def test_get_players_without_filters_returns_200(self):
        """
        Contract Test: GET /api/v1/sports/players returns 200 with player list.

        This test will FAIL until the endpoint is implemented.
        """
        response = self.client.get("/api/v1/sports/players")
    ...
    def test_get_players_with_search_query_returns_filtered_results(self):
        """
        ...
        """
        response = self.client.get("/api/v1/sports/players?search=mahomes")
    ...
    def test_get_players_with_position_filter_returns_filtered_results(self):
        """
        ...
        """
        response = self.client.get("/api/v1/sports/players?position=QB")
    ...
    def test_get_players_with_team_filter_returns_filtered_results(self):
        """
        ...
        """
        response = self.client.get("/api/v1/sports/players?team=KC")
    ...
    def test_get_players_with_pagination_returns_correct_structure(self):
        """
        ...
        """
        response = self.client.get("/api/v1/sports/players?page=1&limit=10")
    ...
    def test_get_players_with_invalid_position_returns_400(self):
        """
        Contract Test: GET /api/v1/sports/players?position=INVALID returns 400.

        This test will FAIL until validation is implemented.
        """
        response = self.client.get("/api/v1/sports/players?position=INVALID")
    ...
    def test_get_players_with_invalid_pagination_returns_400(self):
        """
        Contract Test: GET /api/v1/sports/players?page=0 returns 400.

        This test will FAIL until validation is implemented.
        """
        response = self.client.get("/api/v1/sports/players?page=0")
    ...
    def test_get_players_response_includes_required_fields(self):
        """
        ...
        """
        response = self.client.get("/api/v1/sports/players?limit=1")
        ...
        if data["players"]:
            ...
            required_fields = [
                "player_id", "external_id", "name", "position",
                "team", "sport", "status", "injury_status"
            ]

            for field in required_fields:
                assert field in player, f"Missing required field: {field}"

    def test_get_players_with_stats_includes_stats_data(self):
        """
        ...
        """
        response = self.client.get("/api/v1/sports/players?include_stats=true&limit=1")
    ...
    def test_get_players_supports_cors_headers(self):
        """
        ...
        """
        # Preflight request
        response = self.client.options("/api/v1/sports/players")

        assert response.status_code == 200
        assert "Access-Control-Allow-Origin" in response.headers
        assert "Access-Control-Allow-Methods" in response.headers

    def test_get_players_includes_response_time_header(self):
        """
        ...
        """
        response = self.client.get("/api/v1/sports/players?limit=5")
    ...
    def test_get_players_rate_limiting_headers(self):
        """
