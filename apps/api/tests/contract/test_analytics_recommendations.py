...
class TestAnalyticsRecommendationsContract:
    ...
    def test_get_recommendations_with_invalid_team_returns_404(self, authenticated_client):
        ...
        response = authenticated_client.get(
            "/api/v1/analytics/recommendations?team_id=invalid_team"
        )
    ...
    def test_get_recommendations_includes_different_types(self, authenticated_client):
        """
    ...
    def test_get_recommendations_includes_confidence_scores(self, authenticated_client):
        """
