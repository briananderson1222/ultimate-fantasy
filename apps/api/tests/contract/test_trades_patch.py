...
class TestTradesPatchContract:
    ...
    def test_accept_trade_returns_200_with_updated_trade(self):
        """
        ...
        response = self.client.patch(f"/api/v1/trades/{trade_id}", json=response_data)
    ...
    def test_reject_trade_returns_200_with_updated_trade(self):
        """
        ...
        response_data = {
            "action": "reject",
            "reason": "Not interested in this trade"
        }
    ...
    def test_respond_to_invalid_trade_returns_404(self):
        """
        ...
        response = self.client.patch("/api/v1/trades/invalid_trade", json=response_data)
    ...
    def test_respond_to_expired_trade_returns_400(self):
        """
    ...
    def test_accept_trade_processes_player_transfers(self):
        """
