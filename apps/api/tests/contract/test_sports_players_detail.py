...
class TestSportsPlayersDetailContract:
    ...
    def test_get_player_by_id_returns_200_with_player_data(self):
        """
        ...
        response = self.client.get(f"/api/v1/sports/players/{player_id}")
    ...
    def test_get_player_with_invalid_id_returns_404(self):
        """
        ...
        """
        response = self.client.get("/api/v1/sports/players/nonexistent_player")
    ...
    def test_get_player_response_includes_all_required_fields(self):
        """
        ...
        required_fields = [
            "player_id", "external_id", "name", "position", "team", "sport",
            "status", "injury_status", "height", "weight", "age", "experience"
        ]

        for field in required_fields:
            assert field in player, f"Missing required field: {field}"

    def test_get_player_response_includes_detailed_stats(self):
        """
    ...
    def test_get_player_response_includes_injury_details(self):
        """
        ...
        if player["injury_status"] in ["Questionable", "Doubtful", "Out"]:
            ...
            assert "return_date" in injury_details or injury_details["return_date"] is None

    def test_get_player_response_includes_recent_news(self):
        """
    ...
    def test_get_player_response_includes_fantasy_data(self):
        """
    ...
    def test_get_player_with_include_similar_players(self):
        """
        ...
        """
        player_id = "player_123"
        response = self.client.get(f"/api/v1/sports/players/{player_id}?include_similar=true")
    ...
    def test_get_player_supports_different_data_formats(self):
        """
    ...
    def test_get_player_performance_headers(self):
        """
    ...
    def test_get_player_with_malformed_id_returns_400(self):
        """
        ...
        for malformed_id in malformed_ids:
            response = self.client.get(f"/api/v1/sports/players/{malformed_id}")
    ...
    def test_get_player_security_headers(self):
        """
