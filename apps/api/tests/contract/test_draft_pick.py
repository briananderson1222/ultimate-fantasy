...
class TestDraftPickContract:
    ...
    def test_make_draft_pick_returns_201_with_pick_data(self, authenticated_client):
        """
    ...
    def test_make_draft_pick_includes_next_pick_info(self, authenticated_client):
        """
