...
class TestSportsScoresGetContract:
    ...
    def test_get_scores_returns_200_with_scores_list(self):
        """
        Contract Test: GET /api/v1/sports/scores returns 200 with scores list.

        This test will FAIL until the endpoint is implemented.
        """
        response = self.client.get("/api/v1/sports/scores")
    ...
    def test_get_scores_response_includes_required_fields(self):
        ...
        if data["scores"]:
            ...
            required_fields = [
                ...
                "away_score", "quarter", "time_remaining", "status"
            ]
