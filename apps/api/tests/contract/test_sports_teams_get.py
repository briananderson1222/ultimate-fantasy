...
class TestSportsTeamsGetContract:
    ...
    def test_get_teams_returns_200_with_teams_list(self):
        """
        Contract Test: GET /api/v1/sports/teams returns 200 with teams list.

        This test will FAIL until the endpoint is implemented.
        """
        response = self.client.get("/api/v1/sports/teams")
    ...
    def test_get_teams_with_sport_filter_returns_filtered_results(self):
        """
        ...
        """
        response = self.client.get("/api/v1/sports/teams?sport=NFL")
    ...
    def test_get_teams_response_includes_required_fields(self):
        ...
        if data["teams"]:
            ...
            required_fields = [
                "team_id", "external_id", "name", "abbreviation",
                "city", "sport", "conference", "division"
            ]

            for field in required_fields:
                assert field in team, f"Missing required field: {field}"

    def test_get_teams_with_invalid_sport_returns_400(self):
        """
        Contract Test: GET /api/v1/sports/teams?sport=INVALID returns 400.

        This test will FAIL until validation is implemented.
        """
        response = self.client.get("/api/v1/sports/teams?sport=INVALID")
