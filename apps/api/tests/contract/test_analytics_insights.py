...
class TestAnalyticsInsightsContract:
    ...
    def test_get_insights_returns_200_with_insights(self):
        """
    ...
    def test_get_insights_with_invalid_league_returns_404(self):
        """
        Contract Test: GET insights with invalid league returns 404.

        This test will FAIL until validation is implemented.
        """
        response = self.client.get("/api/v1/analytics/insights?league_id=invalid_league")
    ...
    def test_get_insights_includes_different_categories(self):
        """
        ...
        expected_categories = ["performance", "trends", "matchup_analysis", "roster_balance"]

        # Should have insights from multiple categories
        assert len(set(categories)) >= 2

    def test_get_insights_includes_impact_levels(self):
        """
