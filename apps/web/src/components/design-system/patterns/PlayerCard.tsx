...
export const PlayerCard: React.FC<PlayerCardProps> = ({
  ...
  if (variant === "compact") {
    return (
      <Card
        className={cn("p-3", draggable && "cursor-move", className)}
        draggable={draggable}
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <div className="text-xs text-muted-foreground">({stats.projected.toFixed(1)})</div>
          </div>
        </div>
      </Card>
    );
  ...
  return (
    <Card
      className={cn("w-full", draggable && "cursor-move", className)}
      draggable={draggable}
      onDragStart={onDragStart}
      onDragEnd={onDragEnd}
    >
      <Card.Header>
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col gap-1">
            <div
              className={cn("text-xs px-2 py-1 rounded-full text-center", getStatusColor(status))}
            >
