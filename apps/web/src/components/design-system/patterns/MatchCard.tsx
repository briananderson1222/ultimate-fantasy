...
export const MatchCard: React.FC<MatchCardProps> = ({
  ...
  const { homeTeam, awayTeam, week, projectedPoints, actualPoints, status, playoffImplications } =
    match;
  const isClickable = !!onClick;
  const winner = actualPoints ? getWinner(actualPoints) : null;

  return (
    <Card clickable={isClickable} className={cn("w-full", className)} onClick={onClick}>
      <Card.Header>
        ...
        {playoffImplications && (
          <div className="text-xs text-purple-600 font-medium">{playoffImplications}</div>
        )}
      </Card.Header>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <div className={cn("font-semibold", winner === "away" && "text-green-600")}>
                  {awayTeam.name}
                </div>
            ...
            <div className="text-right">
              {actualPoints && (
                <div className={cn("text-lg font-bold", winner === "away" && "text-green-600")}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <div className={cn("font-semibold", winner === "home" && "text-green-600")}>
                  {homeTeam.name}
                </div>
                <div className="text-sm text-muted-foreground">
            ...
            <div className="text-right">
              {actualPoints && (
                <div className={cn("text-lg font-bold", winner === "home" && "text-green-600")}>
