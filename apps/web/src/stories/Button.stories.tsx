    ...
    <div className="space-y-3">
      <div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button variant="warning" leftIcon="refresh">
            Trade
          </Button>
          <Button variant="danger" leftIcon="trash">
            Drop
          </Button>
          <Button variant="outline" rightIcon="external-link">
            View Profile
          </Button>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button variant="ghost" size="sm" isIconOnly aria-label="Favorite">
            ★
          </Button>
          <Button variant="ghost" size="sm" isIconOnly aria-label="More options">
            ⋮
          </Button>
          <Button variant="outline" size="md" isIconOnly aria-label="Filter">
            ⚡
          </Button>
        </div>
      </div>
    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="inline-flex rounded-lg overflow-hidden border border-gray-300">
          ...
          <Button variant="ghost" size="sm" className="rounded-none border-0 bg-blue-50">
            QB
          </Button>
          <Button variant="ghost" size="sm" className="rounded-none border-0">
            RB
      ...
      <div>
        ...
        <div className="inline-flex rounded-lg overflow-hidden border border-gray-300">
          <Button variant="ghost" size="md" className="rounded-none border-0 bg-blue-50">
            My Team
          </Button>
          <Button variant="ghost" size="md" className="rounded-none border-0">
            All Players
          </Button>
          <Button variant="ghost" size="md" className="rounded-none border-0">
            Free Agents
