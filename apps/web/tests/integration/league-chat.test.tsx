...
describe('League Chat Integration', () => {
  ...
  it('should distinguish between message types', () => {
    ...
    const transactionMessage = screen.getByText('Alice has placed a waiver claim for Player X').closest('.message');
  ...
  it('should highlight current user messages', () => {
    ...
    const otherUserMessage = screen.getByText('Thanks! Your lineup was solid too.').closest('.message');
